...
if not os.path.exists('hyperparameter_optimization/random_forest/logs'):
    os.makedirs('hyperparameter_optimization/random_forest/logs')

# Set path to logs
path_to_logs = 'hyperparameter_optimization/random_forest/logs'
